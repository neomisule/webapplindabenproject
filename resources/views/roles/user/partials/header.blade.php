            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="{{
                        ...
                        (auth()->user()->hasRole('volunteer') ? route('volunteer.dashboard') :
            ...
            @auth
                @if(auth()->user()->hasRole('user'))
                    <li class="header-element">
                        ...
                        @else
                            <a href="{{ route('user.become.volunteer') }}" class="header-link" style="background-color: #1b5e20; color: #fff; padding: 0.375rem 0.75rem; border-radius: 4px;">
