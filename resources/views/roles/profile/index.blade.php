...
$layout = 'roles.volunteer.layouts.main';
} elseif ($user->hasRole('staff') || $user->hasRole('user')) {
$layout = 'roles.staff.layouts.main';
} else {
$layout = 'roles.volunteer.layouts.main';
}
@endphp
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <form action="{{ route('role.profile.update') }}" method="POST" id="profile-form">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                id="phone" name="phone" value="{{ old('phone', $user->phone_number ?? '') }}" required readonly>
                            @error('phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
